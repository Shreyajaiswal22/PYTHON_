...
# major obstacles for beginners when they are first 
...
'''
# For this lesson we will construct our knowledge of OOP 
  in Python by building on the following topics:

# * Objects
# * Using the *class* keyword
# * Creating class attributes
# * Creating methods in a class
# * Learning about Inheritance, Multiple Inheritance
...
# Remember from previous lectures we can use type() 
...
# so how can we create our own Object
...
# The user defined objects are created using the 
# class keyword. 
# The class is a blueprint that defines a nature 
# of a future object.
# From classes we can construct instances. 
# An instance is a specific object created from a 
# particular class.

# For example, above we created the object 'l' 
# which was an instance of a list object.
#
...
### Create a new object type called Car
#class Car():
#    'doc string'
#    pass
## Instance of class
...
# By convention we give classes a name that starts 
# with a capital letter.
# Note how x is now the reference to our new instance 
# of a Car class.
# In other words, we **instantiate** the Car class.
#
# Inside of the class we currently just have pass.
# But we can define class attributes and methods.
#
# An **attribute** is a characteristic of an object.
# A **method** is an operation we can perform 
# with the object.
#
#
# For example we can create a class called Dog. 
# An attribute of a dog may be its breed or its name, 
# while a method of a dog may be defined by a .bark() 
...
#     __init__()
#
# This method is used to initialize the attributes of an 
# object.
# For example:
...
#    'dog class'
#    species='mammal'
#    def __init__(self,breed,name='tyson'):
#        self.breed = breed
#        self.name = name
...
#     __init__()
# is called automatically right after the 
# object has been created:

#     def __init__(self, breed):
# Each attribute in a class definition begins with a 
...
#These Class Object Attributes are the same for any instance of 
#the class. For example, we could create the attribute *species* 
#for the Dog class. Dogs regardless of their breed,name, 
#or other attributes will always be mammals.
#We apply this logic in the following manner:

#class Dog():
##     Class Object Attribute / Class Variable
#    species = 'mammal'
...
# Note that the Class Object Attribute is defined 
# outside of any methods in the class. 
# Also by convention, 
...
# our objects.
# 
# Methods are essential in encapsulation concept of 
# the OOP paradigm. 
# 
# This is essential in dividing responsibilities 
# in programming, especially in large applications.
#
# You can basically think of methods as functions acting 
# on an Object that take the Object itself into account 
...
#c = Circle()
#
#m=int(input('enter how many radius you have: '))
#for i in range(m):
...
#print ('Area is: ',c.area())
#print ('Parameter: ',c.parameter())
#print('Radius: {}, Area: {}'.format(c.getRadius(),c.area()))
...
#print ('Parameter: ',c.parameter())
##
# Great! Notice how we used self. notation to reference attributes 
# of the class within the method calls. 
...
# code reuse and reduction of complexity of a program. 
 
# The derived classes (descendants) override or extend the 
# functionality of base classes (ancestors).

# >> Lets see an example by incorporating our previous work 
#    on the Dog class.
...
#        self.sizee=sizee
#        print("Size is",sizee)
#    def breed(self,breedd):
#        self.breedd=breedd
#        print("breed is",breedd)
#
#class Animal():
#    def __init__(self):
...
# and Dog. 
# The Animal is the base  class, the Dog is 
# the derived class.
#
# The derived class inherits the functionality 
# of the base class.
#
# * It is shown by the eat() method.
#
# The derived class modifies existing behavior 
# of the base class.
#
# * shown by the whoAmI() method.
###
# Finally, the derived class extends the 
...
# Classes in Python can implement certain
#  operations with special method names. 
#  These methods are not actually called
...
#
#    def __del__(self):
##        print('hello destructor is not yet called')
#        print ("A book is destroyed")
##        del Book.title
##        for i in 'destructor':
##            print(i,end=' ')
#        
#book = Book("Python Rocks!", "Ronaldo", 159)
##
####Special Methods
#print (book)
#print (book.__len__())
...
# The __init__(), __str__(), __len__() and the __del__() 
# methods.
...
##
# **Great! After this lecture you should have a basic 
# understanding of how to create your own objects with class 
# in Python. You will be utilizing this
...
#class Car():
#    def __init__(self,brand=None,model=None,color=None,price=None):
#        self.brand=brand
#        self.model=model
#        self.color=color
#        self.price=price
#
#    def setAttr(self,brand,model,color,price):
#        self.brand=brand
#        self.model=model
#        self.color=color
#        self.price=color
...
#
#v=Vehicle()
#v.setAttr('Audi','A7','White','10 lacs')
#v.getAttr('Adi')